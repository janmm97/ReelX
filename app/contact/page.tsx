        ...
        <div style={{ maxWidth: 480, textAlign: 'center' }}>
          ...
          <div style={{
            ...
            <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
              <rect x="2" y="5" width="18" height="13" rx="2.5" stroke="#787878" strokeWidth="1.4" />
              <path d="M2 8L11 13.5L20 8" stroke="#787878" strokeWidth="1.4" strokeLinecap="round" />
            </svg>
          </div>
          ...
          <p style={{ fontSize: 15, color: '#787878', lineHeight: 1.7, margin: '0 0 36px' }}>
          ...
          >
            <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
              <rect x="1" y="3" width="13" height="9.5" rx="2" stroke="#000000" strokeWidth="1.3" />
              <path d="M1 5.5L7.5 9.5L14 5.5" stroke="#000000" strokeWidth="1.3" strokeLinecap="round" />
            </svg>
            support@reelx.app
          </a>

          <p style={{ fontSize: 12, color: '#787878', marginTop: 20 }}>
